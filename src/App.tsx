...
function App() {
  ...
  const [openBracket, setOpenBracket] = useState<boolean>(false)
  const [input, setInput] = useState<string[]>([])
  const [output, setOutput] = useState<string[]>([])
  const [equalStored, setEqualStored] = useState<number>()
  ...
  const pressedDivide = () => {  }
  const pressedEqual = () => {  }
  const checkType = (object: any[]) => {
    if (typeof object === "string") {
      return object
    } else return object.join("")
  }
  let objectInput = checkType(input)
  let objectOutput = checkType(output)
  return (
    <div className="App">
            <div id="bg">
